...
{
    // o vetor de coordenadas na textura vai ter as mesmas dimensões dos vertices
    textureCoords.resize(numVertices);

    // define o tamanho máximo do cilindro no eixo Z usando a mesma estratégia
    // usada para determinar a bounding box no rescale para caber exatamente
    // no viewport (rescaleModel)
    ...
    // calcula as coordenadas de textura em s, t a partir dos vértices
    for (size_t i{0}; i < numVertices; ++i)
    {
...
// Calcula os vetores tangentes a partir dos vértices
