...
void OpenGLWidget::createVBOs(std::shared_ptr<Model> m)
{
    ...
    // bind dos vértices das normais na GPU
    ...
    // bind das coordenadas de textura na GPU
...
// o loadTexture em 3D é feito da mesma forma que em 2D, com a exceção que agora existe wrap em s,t
